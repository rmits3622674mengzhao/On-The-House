...
class RatingController: UIStackView {
    var starsRating = 0
    var starsEmptyPicName = "heart_empty" // change it to your empty star picture name
    var starsFilledPicName = "heart_full" // change it to your filled star picture name
