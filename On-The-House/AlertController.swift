...
let SCREEN_WIDTH:CGFloat = UIScreen.main.bounds.size.height //屏幕宽度
...
class ZuberAlert: UIViewController {
    ...
    public func setupSubtitleTextView() {
...
extension ZuberAlert{
    ...
    //MARK: -alert 方法主体
    func showAlert(title: String?, subTitle: String?,buttonTitle: String ,otherButtonTitle:String?,action:@escaping ((_ OtherButton: UIButton) -> Void)) {
        userAction = action
